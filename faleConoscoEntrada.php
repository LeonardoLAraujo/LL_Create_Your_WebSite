<?php
    ...
    $sql = mysqli_query($conecta, "select * from tb_faleconosco where nome = '$nome'"); //O $conecta é a variável do conexao.php
    ...
    if($sql2 > 0){ //Caso tenha um cadastro já cadastrado
        ...
        $sql = mysqli_query($conecta, "insert into tb_faleconosco (nome, email, msg)values('$nome','$email','$msg')"); //O $conecta é a variável do conexao.php
